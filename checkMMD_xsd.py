...
class CheckMMD():
    """ Class to verify if MMD file is in compliance with the requirements
        ...
        Args:
            ...
            xsd (file):      absolute path to XSD for MMD
            xslt (file):     absolute path to XSLT transforming MMD according
                             to required order in XSD
    """
...
def main():
    ...
    xsd = '/path/to/my/XSD/mmd.xsd'
    xslt ='/path/to/my/XSL/sort_mmd_according_to_xsd.xsl'
